...
try:
    from agent_workflow.context.models import AgentMemory, Decision, PhaseHandoff, Pattern, ContextSnapshot
    from agent_workflow.context.interfaces import IAgentMemory
except ImportError:
    try:
        from lib.context.models import AgentMemory, Decision, PhaseHandoff, Pattern, ContextSnapshot
        from lib.context.interfaces import IAgentMemory
    except ImportError:
...
try:
    ...
    try:
        from lib.tdd_models import TDDState, TDDTask, TDDCycle
    except ImportError:
