...
try:
    from agent_workflow.context.models import TokenBudget, TokenUsage, FileType, CompressionLevel
    from agent_workflow.context.interfaces import ITokenCalculator
except ImportError:
    try:
        from lib.context.models import TokenBudget, TokenUsage, FileType, CompressionLevel
        from lib.context.interfaces import ITokenCalculator
    except ImportError:
