...
from ...security.tool_config import AgentType, get_claude_tool_args
...
def create_agent_client(agent_type: AgentType, timeout: int = 300) -> ClaudeClient:
    """Create a Claude client with agent-specific tool restrictions"""
    return ClaudeClient(timeout=timeout, agent_type=agent_type)
